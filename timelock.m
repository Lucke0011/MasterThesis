function [timelocked] = timelock(data, params)
...
for i_trigger = 1:length(params.trigger_codes)
    ...
    %saveas(h, fullfile(save_path, 'figs', [params.paradigm '_butterflyPlot_trig-' params.trigger_labels{i_trigger} label '.jpg']))
    close all
